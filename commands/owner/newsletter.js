 ...
 * @param {string} link - Channel link (e.g., https://whatsapp.com/channel/0029VbCi5847oQhhirgtei00)
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!text || text.trim().length === 0) {
        return extra.reply('❌ Please provide a WhatsApp channel link!\n\nExample: .newsletter https://whatsapp.com/channel/0029VbCi5847oQhhirgtei00');
      }
      ...
      if (!inviteCode) {
        return extra.reply('❌ Could not extract invite code from the link!\n\nPlease provide a valid WhatsApp channel link.\nExample: https://whatsapp.com/channel/0029VbCi5847oQhhirgtei00\n\nOr just the invite code: .newsletter 0029VbCi5847oQhhirgtei00');
      }
