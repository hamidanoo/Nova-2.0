...
async function startBot() {
  ...
  const ghost = JSON.parse(fs.readFileSync("./data/ghost.json"));
...
💬 Caption :
${msg.imageMessage.caption || "No caption"}
...
💬 Caption :
${msg.videoMessage.caption || "No caption"}
...
`,
        ...
        console.log("Ghost command Error:", err);
      }
    }
  }
});
